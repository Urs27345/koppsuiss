  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.context}>
        <p>
          Welcome to the Santa Cruz page ! Discover the fascinating culture, vibrant history, and breathtaking nature of
          this special region. Santa Cruz offers a unique blend of traditional charm and modern life that attracts
